...
public class Video3 extends javax.swing.JFrame {
    ...
    public Video3() {
        ...
        createScene();
        setTitle("4 Trucos para dormir toda la noche como un bebé");
        setResizable(true);
    ...
    File file = new File("G:\\PROYECTOS\\Psicología\\Videos\\4 Trucos para dormir toda la noche como un bebé.mp4");
    ...
    private void atras_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_atras_buttonActionPerformed
        try {
            ...
            Logger.getLogger(Video3.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Video3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
